...
public class games {
    public static void main(String[] args) {
        ...
        String[] tipoAcao = { "1- Metal Gear Solid 5 - Em desconto: The Phantom Pain -- R$50,00", "2- Elden Ring -- RS80,90", "3- Resident Evil 4 Remake -- R$95,00" };
        String[] tipoCorrida = {"4- Forza Horizon 5 -- R$70,00", "5- Gran Turismo - Em desconto -- R$70,00", "6- F1 2021 -- R$ 70,00"  };
        String[] tipoAventura = { "7- Death Stranding -- R$ 90,80", "8- Subnautica -- R$99,99", "9- The Elder Scrolls V: Skyrim -- R$110,00'" };
